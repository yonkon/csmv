...
if ($discount > 0) {
    ...
    $msg = __('discount');
echo <<<EOT
        <INPUT type="hidden" NAME="itemNumber$counter" VALUE="{$msg}">
        <INPUT type="hidden" NAME="itemDescription$counter" VALUE="{$msg}">
        <INPUT type="hidden" NAME="itemQuantity$counter" VALUE="1">
        <INPUT type="hidden" NAME="itemPrice$counter" VALUE="{$discounts}">
EOT;
$counter++;
}
...
echo <<<EOT
        <input type="hidden" name="itemNumber$counter" value="{$gc_data['gift_cert_id']}">
        <input type="hidden" name="itemDescription$counter" value="$gc_code">
        <INPUT type="hidden" NAME="itemQuantity$counter" VALUE="1">
        <INPUT type="hidden" NAME="itemPrice$counter" VALUE="{$amount}">
EOT;
$counter++;
    }
}
...
echo <<<EOT
        <INPUT type="hidden" NAME="itemNumber$counter" VALUE="{$tax_id}">
        <INPUT type="hidden" NAME="itemDescription$counter" VALUE="{$msg}">
        <INPUT type="hidden" NAME="itemQuantity$counter" VALUE="1">
        <INPUT type="hidden" NAME="itemPrice$counter" VALUE="{$amount}">
EOT;
