...
class Filters
{
    ...
    public static function outputTranslateWrapper($content, \Smarty_Internal_Template $template)
    {
        ...
        $replacement = '<var class="translate-wrap"><i class="cm-icon-translate icon-translate ty-icon-translate"></i><var data-ca-translate="$2$3" class="cm-translate translate-item">$4</var></var>';
        while (preg_match($pattern, $content, $matches)) {
            $phrase_replaced = $matches[0];
