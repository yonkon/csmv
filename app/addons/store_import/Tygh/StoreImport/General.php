...
class General
{
    ...
    {
        if (in_array($store_data['product_version'], array('4.0.1', '4.0.2', '4.0.3', '4.1.1', '4.1.2', '4.1.3', '4.1.4'))) {
            return false;
        }
        $mapping = array(
            '4' => array(
    ...
    public static function setActualLangValues()
    {
        ...
        foreach (db_get_fields("SELECT lang_code FROM ?:languages") as $lang_code) {
            ...
            db_query("INSERT INTO ?:settings_descriptions "
                    . "(SELECT object_id, object_type, ?s as lang_code, value, original_value, tooltip FROM " . $prefix . "settings_descriptions WHERE object_id IN "
