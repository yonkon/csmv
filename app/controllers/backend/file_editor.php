...
$_SESSION['active_section'] = empty($_SESSION['active_section']) ? 'themes' : $_SESSION['active_section'];
...
function fn_te_filter_path($path, $active_section)
{
    ...
    fn_set_hook('te_filter_path', $filter, $path, $active_section);
