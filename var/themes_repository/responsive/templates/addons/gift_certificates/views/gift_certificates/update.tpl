...
{if $templates}
    ...
    {include file="buttons/button.tpl" but_text=__("preview") but_name="dispatch[gift_certificates.preview]" but_meta="cm-new-window" but_role="submit" but_meta="ty-btn__tertiary"}
    </div>
{/if}
</div>
