...
<div class="ty-tags-summary">
        <ul class="ty-tags-summary__list clearfix">
            <li class="ty-tags-summary__item tag-inner">
        ...
        {if $tag.products}
            <div class="ty-tags-summary__group-title tags-group">{__("products")}:</div>
            ...
            {foreach from=$tag.products item="tag_product" key="tag_product_id"}
                <li class="ty-tags-summary__group-item">
                    {include file="buttons/button.tpl" but_href="tags.delete?tag_id=`$tag.tag_id`&object_type=P&object_id=`$tag_product_id`&redirect_url=`$return_current_url`" but_meta="ty-btn__secondary cm-confirm ty-tags-summary__group-delete" but_role="delete"}
...
<div class="{cycle values="hidden,hidden,hidden,clearfix"} tags-clear"></div>
