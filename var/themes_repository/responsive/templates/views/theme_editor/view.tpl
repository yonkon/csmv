                    ...
                    <ul class="te-select-dropdown" id="elm_te_styles">
                        {foreach from=$styles_list item="s_item"}
                            <li class="{if $runtime.layout.style_id === $s_item.style_id}active{/if}">
                                <a class="cm-te-load-style te-list-item {if $runtime.layout.style_id === $s_item.style_id}active{/if}" data-ca-target-id="theme_editor" href="{"theme_editor.view?style_id=`$s_item.style_id`"|fn_url}" data-ca-style-id="{$s_item.style_id}">{$manifest.names[$s_item.name]|default:$s_item.name}</a>
                        ...
                        {if $field.full_width}
                            ...
                            <div class="te-fullwidth te-checkbox clearfix">
                                <label for="elm_toggle_full_width_{$name}">
                                    ...
                                    <input type="checkbox" name="style[data][{$field.full_width.match}]" class="cm-te-value-changer" id="elm_toggle_full_width_{$name}" value="true" {if $current_style.data[$field.full_width.match] == "true"}checked="checked"{/if}><span class="te-toggle"><span class="te-toggle-on">{__("theme_editor.on")}</span><span class="te-toggle-off">{__("theme_editor.off")}</span><span class="te-toggle-trigger"></span></span><span class="te-bg-title">{__("theme_editor.full_width")}</span></label>
                            </div>
                            {else}
                            <div class="te-fullwidth te-checkbox clearfix">
