    ...
    <div id="apply_for_vendor_account" > {* content detailed *}
        ...
        <form action="{"companies.apply_for_vendor"|fn_url}" method="post" name="apply_for_vendor_form">
            ...
            {if !$auth.user_id && $settings.Vendors.create_vendor_administrator_account == "Y"}
                ...
                {/if}
                <div class="ty-control-group shipping-first-name" id="company_description_admin_firstname">
                ...
                <div class="ty-control-group shipping-last-name" id="company_description_admin_lastname">
            ...
            <div class="ty-control-group ">
                <label class="ty-control-group__title" for="company_address_address" class="cm-required">{__("address")}</label>
            ...
            <div class="ty-control-group">
                <label class="ty-control-group__title" for="company_address_city" class="cm-required">{__("city")}</label>
