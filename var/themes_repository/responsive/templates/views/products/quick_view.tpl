<div class="ty-quick-view__wrapper">
    ...
    <div class="ty-product-block product-main-info product-quick-view" id="product_main_info_{$obj_prefix}">
                        ...
                        {hook name="products:quick_view_title"}
                            {if !$hide_title}
                                <h1 class="ty-product-block-title">
                                    <a href="{"products.view?product_id=`$product.product_id`"|fn_url}" class="ty-quick-view__title">{$product.product nofilter}</a>
                                </h1>
                            {/if}
                        {/hook}
