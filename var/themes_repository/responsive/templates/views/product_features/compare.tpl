...
{else}
    ...
    <div class="ty-compare">
        ...
        <div class="ty-compare__wrapper">
            <div class="ty-compare-products">
                {foreach from=$comparison_data.products item=product}
                    <div class="ty-compare-products__product">
                        ...
                        <div class="ty-compare-products__item ty-compare-products_padding">
                        ...
                        <div class="ty-compare-products__item ty-compare-products_padding">{include file="blocks/list_templates/simple_list.tpl" min_qty=true product=$product show_add_to_cart=true but_role="action" hide_price=true}</div>
                    </div>
                {/foreach}
            </div>
                            ...
                            {foreach from=$comparison_data.products item=product}
                                ...
                                {strip}
                                    ...
                                    {if $feature.feature_type == "C"}
                                        <span class="ty-compare-checkbox" title="{$feature.value}">{if $feature.value == "Y"}<i class="ty-icon-ok"></i>{/if}</span>
                                    ...
                                    {elseif $feature.feature_type == "M" && $feature.variants}
                                        <ul class="ty-float-left compare-list">
                                        {foreach from=$feature.variants item="var"}
                                        {if $var.selected}
                                        <li class="ty-compare-list__item"><span class="ty-compare-checkbox" title="{$var.variant}"><i class="ty-icon-ok"></i></span>{$var.variant}</li>
                                        {/if}
                                        {/foreach}
                                        </ul>
