                                    ...
                                    {foreach from=$item1.$childs item="item2" name="item2"}
                                        <li class="ty-top-mine__submenu-col">
                                            ...
                                            <div class="ty-menu__submenu-item-header">
                                                <a{if $item2_url} href="{$item2_url}"{/if} class="ty-menu__submenu-link {if $item2.active || $item2|fn_check_is_active_menu_item:$block.type} ty-menu__submenu-link-active{/if}">{$item2.$name}</a>
                                            </div>
                                            {if $item2.$childs}
                                                <div class="ty-menu__item-toggle visible-phone cm-responsive-menu-toggle">
                                                    <i class="ty-menu__icon-open ty-icon-down-open"></i>
