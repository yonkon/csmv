<div id="translate_box" class="hidden translate-box">
    ...
    {if $languages|sizeof > 1}
        <div id="translate_box_menu_language_selector" class="ty-float-right">
            {if !"ULTIMATE:FREE"|fn_allowed_for}
                <div class="ty-iinline" id="translate_box_language_selector">
    ...
    <textarea id="trans_val" class="textarea-resize" cols="40" rows="3"></textarea>
