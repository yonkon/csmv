...
{function name="profile_edit_link"}
    ...
    <div class="pull-right">
        <a class="hand cm-tooltip icon-edit cm-dialog-opener{if $click_to} cm-external-click{/if}" {if $click_to}data-ca-external-click-id="{$click_to}"{/if} data-ca-target-id="customer_info" data-ca-scroll="{$scroll_to}" title="{__("edit")}"></a>
    </div>
    {/if}
{/function}
